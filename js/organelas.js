const infoData = {
    mitocondria: {
        ...
        conteudo: `
                        ...
                        mitocondrial. Na matriz mitocondrial, encontra-se uma grande quantidade de enzimas que atuam na
                        respiração celular, outras proteínas, material genético (<abbr
                        title="Saiba Mais em: https://www.todamateria.com.br/dna/"><a
                            href="https://www.todamateria.com.br/dna/"
                            target="_blank">DNA</a></abbr> e <abbr
                        title="Saiba Mais em: https://www.todamateria.com.br/rna//"><a
                            href="https://www.todamateria.com.br/rna/" target="_blank">RNA</a></abbr>) e ribossomos.</p>
        
                        <p>A sua função é realizar a respiração celular
                        que produz a maior parte da energia utilizada nas funções vitais do corpo.</p>
                    ...
                    <div class="divIframes">
                        ...
                        <details>
                            ...
                            Em vez de oxigênio diretamente, outras substâncias (como nitratos, sulfatos ou carbono) 
                            atuam nas reações químicas. As mitocôndrias são capazes de se fundir e de se dividir 
        ...
        conteudo: `<p>Os lisossomos são vesículas envolvidas apenas pela bicamada lipídica e no seu interior há
                                        enzimas digestivas. Sua função é digerir moléculas orgânicas como <abbr
                                            title="Saiba Mais em: https://www.todamateria.com.br/o-que-sao-lipidios-funcoes-e-tipos/"><a
                                                ...
                                                target="_blank">lipídios</a></abbr>,
                                        carboidratos, <abbr title="Saiba Mais em: https://www.todamateria.com.br/proteinas/"><a
                                                href="https://www.todamateria.com.br/proteinas/"
                                                target="_blank">proteínas</a></abbr>, <abbr
                                            title="Saiba Mais em: https://www.todamateria.com.br/dna/"><a
                                                href="https://www.todamateria.com.br/dna/"
                                                target="_blank">DNA</a></abbr>, <abbr
                                    ...
                                    <details>
                                        ...
                                        <p> Nos unicelulares, como protozoários, a endocitose é
                                        ...
                                        <p> Em organismos multicelulares, por sua vez, a endocitose tem um papel um pouco
                                            ...
                                            que
                                            captam partículas e organismos invasores.</p>
    ...
    citoplasma: {
        ...
        conteudo: `<p>O citoplasma é a parte da célula que fica entre a membrana plasmática e o núcleo, onde
                                        ...
                                        title="Saiba Mais em: https://www.todamateria.com.br/hialoplasma/"><a
                                            href="https://www.todamateria.com.br/hialoplasma/" target="_blank">citosol</a></abbr>, que contém água, sais, proteínas e outros nutrientes essenciais para a
    ...
    nucleo: {
        ...
        conteudo: ` <p> O núcleo é a principal organela da célula eucariótica, armazenando o DNA, que contém as
                                        ...
                                        ocorre a síntese de <abbr
                                        title="Saiba Mais em: https://www.todamateria.com.br/proteinas/"><a
                                            href="https://www.todamateria.com.br/rna/" target="_blank">RNA</a></abbr> ribossômico (rRNA), essencial para a formação de ribossomos. O
        ...
        conteudo: `
                        <p>São as organelas mais abundantes nas células. Ribossomos são estruturas celulares, presentes
                                        em células procarióticas e eucarióticas, responsáveis pela síntese de <abbr
                                            title="Saiba Mais em: https://www.todamateria.com.br/proteinas/"><a
                                                href="https://www.todamateria.com.br/proteinas/"
                                                target="_blank">proteínas</a></abbr>. Essas
    ...
    rel: {
        ...
        conteudo: ` <p>O retículo endoplasmático liso (REL) é uma organela presente nas células     eucarióticas,
                                        ...
                                        title="Saiba Mais em: https://www.todamateria.com.br/o-que-sao-lipidios-funcoes-e-tipos/"><a
                                            href="https://www.todamateria.com.br/o-que-sao-lipidios-funcoes-e-tipos/"
                                            target="_blank">lipídios</a></abbr> (como fosfolipídios e
    ...
    peroxissomos: {
        ...
        conteudo: `<p>  Elas são vesículas de enzimas envolvidas por uma membrana, em forma esférica. São organelas onde acontecem reações de oxidação, responsáveis por desintoxicar as células e o organismo, principalmente em órgãos como o fígado e os rins. As enzimas dos peroxissomos metabolizam substâncias estranhas às células e metabolizam.</p> 
                                    ...
                                    <p>   Peroxissomos apresentam diferentes enzimas a depender da célula analisada. Nas células do fígado e dos rins, por exemplo, muitas substâncias tóxicas são oxidadas, como os medicamentos.
                                        ...
                                        title="Saiba Mais em: https://mellislab.com.br/manual-de-exames/acidos-biliares"><a
                                            href="https://mellislab.com.br/manual-de-exames/acidos-biliares"
                                            target="_blank">ácidos biliares</a></abbr> e colesterol.</p>  
    ...
    membrana: {
        ...
        conteudo: `<p>A membrana plasmática envolve todas as células e regula o que entra e sai delas. Composta
                                        ...
                                        title="Saiba Mais em: https://www.todamateria.com.br/homeostase/"><a
                                            href="https://www.todamateria.com.br/homeostase/"
                                            target="_blank">homeostase</a></abbr>)
    ...
    parede: {
        ...
        conteudo: `<p> Presente em células vegetais, fungos e algumas bactérias, a parede celular é uma
                                    ...
                                    <p>Nas plantas, é composta principalmente de celulose, um polissacarídeo que confere
    ...
    vacuolos: {
        ...
        conteudo: ` <p>O vacúolos são desenvolvidos em células vegetais, e em algumas poucas células animais, é
                                    ...
                                    <p>
                                        ...
                                        depois são desfeitos. Células animais não possuem vacúolos de reserva.</p>
                                    <p> Os vacúolos de reserva são estruturas que armazenam diferentes tipos de substâncias
                                    ...
                                    <details>
                                        ...
                                        <p>As vesículas são pequenas estruturas membranosas presentes em células eucarióticas,
                                            ...
                                            Isso as torna fundamentais no processo de transporte e comunicação intracelular.</p>
                                    </details>
                                    <details>
